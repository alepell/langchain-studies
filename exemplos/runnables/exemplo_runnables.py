...
# respostaLambda = runnable.invoke(1)

# print("------ RESPOSTA DO INVOKE RunnableLambda  -")
# print(respostaLambda)
# print("-------------------------------------------")
...
# runnable_2 = RunnableLambda(
#     mul_two
# )  # Convertendo a função de multiplicação para runnable
...
# runnable_2 = RunnableLambda(
#     mul_two
# )  # Convertendo a função de multiplicação por 2 para runnable
# runnable_3 = RunnableLambda(
#     mul_three
# )  # Convertendo a função de multiplicação por 3 para runnable
...
# chain = (
#     RunnablePassthrough()
#     | RunnableLambda(entrada_para_letras_maiusculas)
#     | RunnablePassthrough()
# )
...
# forma explícita — com def (idêntico em resultado)
def mul3(x):
    return x["num"] * 3


runnable = RunnablePassthrough() | RunnablePassthrough.assign(
    multiplica_3=lambda x: x["num"] * 3
)
runnable2 = RunnablePassthrough() | RunnablePassthrough.assign(multiplica_3=mul3)

resposta = runnable.invoke({"num": 3})
resposta2 = runnable2.invoke({"num": 4})
